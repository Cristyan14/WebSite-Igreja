...
if (!empty($_GET['search'])) {
    $data = $_GET['search'];
    $sql = "SELECT * FROM virada WHERE id LIKE ? OR nome LIKE ? OR cpf LIKE ? or lote_familia LIKE ? OR numero LIKE ? OR sobremesa LIKE ? ORDER BY id DESC";
    $stmt = $conexao->prepare($sql);
    $param = '%' . $data . '%';
    $stmt->bind_param('ssssss', $param, $param, $param, $param, $param, $param,);
} else {
    $sql = "SELECT * FROM virada ORDER BY id DESC";
    $stmt = $conexao->prepare($sql);
}
        ...
        <table class="table text-white table-bg" >
            <thead style="color:black;">
                <tr>
                    ...
                    <th scope="col">CPF</th>
                    <th scope="col">Lote Familía</th>
                    <th scope="col">Numero</th>
                    <th scope="col">Sobremesa</th>           
                    <th scope="col">Pagamento Final</th>
            ...
            <tbody style="color:black;">
                <?php
                    while($user_data = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<td>".$user_data['lote_familia']."</td>";
                        echo "<td>".$user_data['numero']."</td>";
                        echo "<td>".$user_data['sobremesa']."</td>";
