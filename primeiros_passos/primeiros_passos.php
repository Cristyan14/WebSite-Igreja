...
<head>
    ...
    <link rel="stylesheet" href="../css/style_primeiros_passos.css">
...
<header id="header">
    ...
    <main>
    <section class="primeiros_passos">
        <div class="limitador">
            <form action="inscricao.php" method="POST">
                <h1>Inscrição - Primeiros Passos</h1>
                <div class="div">
                ...
                <div class="div">
                <label for="dia">Dia para realização do curso: </label><BR></BR>
                <select name="dia" id="" required>
                    <option value="">Selecione uma opção</option>
                    <option value="domingo">Domingo ás 09:00</option>
                    <option value="terca">Terça ás 19:30</option>
                </select>
                </div>
                <div class="div">
